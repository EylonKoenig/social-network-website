        ...
        <Fragment>
            ...
            <form className="form">
                <div className="form-group">
                    <select name="" id="" className="status" value={status} onChange={e => onChange(e)}>
                        <option value="0">Select Professinal Status</option>
                        <option value="Developer">Developer</option>
                        <option value="Junior Developer">Junior Developer</option>
                        <option value="Senior Develpoer">Senior Develpoer</option>
                ...
                <div className="form-group">
                    <textarea name="bio" id="" cols="30" rows="10" placeholder="A short bio of yourself" value={bio} onChange={e => onChange(e)}></textarea>
                    <small className="form-text">
